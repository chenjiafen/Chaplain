package com.chenjiafeng.aspect;
...
public class WebLogAspect {
     ...
     * <p>public * cn.codemao.autotest.controller..*.*(..))
     ...
     * @param
     */
    @Pointcut("execution(public * com.chenjiafeng.controller.*.*(..))")
    ...
    @AfterReturning(returning = "rtn", pointcut = "exectionMethod()")
